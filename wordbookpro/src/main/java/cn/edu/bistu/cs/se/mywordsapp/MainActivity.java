...
public class MainActivity extends AppCompatActivity implements WordItemFragment.OnFragmentInteractionListener, WordDetailFragment.OnFragmentInteractionListener {
    ...
    private String wordMeaning ="error";
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (strMeaning.equals("")||strMeaning.equals(null)){
                            YoudaoOpenAPI(strWord);
                        }else {
                            WordsDB wordsDB = WordsDB.getWordsDB();
    ...
    private void YoudaoOpenAPI(final String strWord){
    ...
    private boolean parseJson(String json,String strWord) {
        String translation = "";
        try {
        ...
        WordsDB wordsDB = WordsDB.getWordsDB();
        wordsDB.Insert(strWord,translation,"");
        RefreshWordItemFragment();
        return true;
    }
